...
function OWW() {
  ...
  return (
    <div className="oww">
      ...
      <div className="project__background project__background--oww" />

      <Scroll3D content={content} initialZ={-200} zIndex={-1} />

      <div className="project__content" >

        <div className="project-card__outer project-card__outer--oww">
          ...
          <div className="project-card project-card--oww">
            ...
            <div className="grid__2-3">
              <div>
                ...
                <p className="add-break">
                  During the production phase, I lead a team of seven 2nd-year students. In groups, they successfully developed the User Interface, Character Design and 2D Assets.
            </p>
                <p className="add-break">
              ...
              <img className="exposure-image" src="./images/exposure.jpg" alt="Louis Earl standing in front of a One Way Wellington poster." />
            </div>
          </div>
        </div>
        ...
        <div className="project-card__outer project-card__outer--oww">
          <div className="project-card project-card--oww">
            <iframe className="responsive-iframe" src="https://www.youtube-nocookie.com/embed/yEqYl7gQWyg?rel=0&fs=0&loop=1&modestbranding=1" title="YouTube video player" frameBorder="0"></iframe>
          </div>
        </div>
        ...
        <div className="project-card__outer project-card__outer--oww">
          <div className="project-card project-card--oww">
            ...
            <img className="project-image oww-image--break" src="./images/oww-game.jpg" alt="Build your ship, travel the galaxy and collect passengers in One Way Wellington." />
